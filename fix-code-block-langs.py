...
Usage: python3 fix-code-block-langs.py [directory]
"""
                ...
                if fl >= fence_len:
                    ...
                    if current_lang and code_lines:
                        ...
                        if new_lang != current_lang:
                            ...
                            indent = old_fence[:len(old_fence) - len(old_fence_stripped)]
...
def fix_language_tag(current_lang, content):
    ...
    if current_lang in ('text', 'mermaid', 'yaml', 'json', 'bash', 'shell',
                        'sql', 'html', 'css', 'diff', 'dockerfile', 'python',
                        'plaintext', 'markdown'):
        return current_lang
