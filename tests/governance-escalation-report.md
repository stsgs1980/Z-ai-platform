...
- Enforcement scripts created: 11 scripts in `guard/scripts/` covering 15/17 rules.
- Remaining rules (ANSWER-001, STRUCT-007) require LLM behavioral judgment.
...
Active defects: 14 (down from 32; 18 resolved)
Enforcement: 15/17 rules enforced via pre-commit (was 2/17)
Remaining undeclared: 2 rules requiring LLM judgment (ANSWER-001, STRUCT-007)
